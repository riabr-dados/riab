...
SCRIPTS = [
    ...
    "pipelines/transform/clean_oca_financeiros.py",
    "pipelines/transform/clean_captacao.py",
    ...
    "pipelines/transform/clean_cnc_split.py",
    "pipelines/transform/clean_bfi_split.py",
    "pipelines/transform/clean_ancine_pda.py",
    "pipelines/transform/aggregate_crt.py",
